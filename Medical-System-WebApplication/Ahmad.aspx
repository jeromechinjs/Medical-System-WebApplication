<%@ Page Title="Dr.Ahmad - Dose Vaccination" Language="C#" MasterPageFile="~/Header_Footer_Template.Master" AutoEventWireup="true" CodeBehind="Ahmad.aspx.cs" Inherits="Medical_System_WebApplication.Ahmad" %>
				...
				<div class="row">
					...
					<div class="col">
						<div class="container mt-3">
							...
							<div class="mb-3 me-3">
								<p><strong>Specialty &nbsp;&nbsp;&nbsp;&nbsp;:</strong>  Dose Vaccination</p>
								<p><strong>Languages &nbsp;&nbsp;:</strong>  English, Bahasa Melaysia</p>
